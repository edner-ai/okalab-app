...
alter table public.platform_settings
  add column if not exists usd_to_dop numeric;

alter table public.platform_settings
  add column if not exists usd_to_htg numeric;

alter table public.payment_methods
  add column if not exists visible_countries text[] not null default '{}'::text[];
