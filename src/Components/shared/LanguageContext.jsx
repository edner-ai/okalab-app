...
export const DEFAULT_TRANSLATIONS = {
  es: {
    ...
    materials_immediate_access: "Materiales inmediatos tras pago",
    materials_immediate_access_help: "Si está activo, estudiantes con pago aprobado acceden enseguida. Si está desactivado, se habilitan desde la fecha de inicio del seminario.",
    material_preview_public: "Visible antes de pagar",
    material_preview_public_help: "Úsalo para compartir materiales abiertos, como el currículo del seminario.",
    material_preview_public_badge: "Vista previa",
    materials_link_unavailable: "Este archivo se habilitará cuando tu acceso quede confirmado.",
    materials_empty_private: "El profesor aún no ha cargado materiales para este seminario.",
    materials_payment_required: "Tu pago debe estar aprobado para acceder a los materiales.",
    materials_start_date_locked: "Los materiales se habilitan en la fecha de inicio del seminario.",
    materials_enroll_and_pay_to_access: "Inscríbete y paga para acceder a los materiales.",
    materials_preview_note: "Estos materiales se comparten antes del pago. Si el profesor añadió otros materiales privados, se desbloquean según las reglas del seminario.",
    ...
    surplusExplanation: "Si el total recaudado supera tu objetivo, {percent}% del excedente neto es para ti como bonus.",
    referralSuccess: "¡Comparte tu enlace para reducir tu precio y ganar bonos!",
    economic_conditions_title: "Condiciones de excedente y bonos",
    economic_conditions_subtitle: "Resumen claro de cómo Okalab liquida el excedente y cuándo se liberan los bonos.",
    economic_conditions_professor_title: "Para el profesor",
    economic_conditions_professor_body: "Si el seminario supera el objetivo, recibes {percent}% del excedente neto como bonus. La liquidación económica final se confirma al cerrar la ventana de pago.",
    economic_conditions_referrals_title: "Para referidos",
    economic_conditions_referrals_intro: "Comparte tu enlace de invitación. Si tus invitados pagan y el seminario supera el objetivo, puedes recibir bonos. Condiciones aplican.",
    economic_conditions_referrals_rule_paid: "Solo cuentan las inscripciones pagadas cuando cierra la ventana de pago.",
    economic_conditions_referrals_rule_surplus: "Solo generan bono los estudiantes que quedaron realmente en excedente y son atribuibles a tu enlace.",
    economic_conditions_referrals_rule_release: "El bono se libera si tú también pagaste tu propia inscripción dentro de la ventana y el seminario finaliza correctamente.",
    economic_conditions_referrals_rule_fallback: "Si no cumples esas condiciones o no hay un referido válido atribuible, ese valor vuelve a profesor y plataforma.",
    economic_conditions_legal_note: "También puedes revisar Soporte y Términos para el detalle completo de estas reglas.",
    economic_conditions_inline_cta: "Condiciones aplican.",
    economic_conditions_view: "Ver condiciones",
    title: "Título",
  ...
  en: {
    ...
    download: "Download",
    materials: "Materials",
    materials_immediate_access: "Materials available right after payment",
    materials_immediate_access_help: "If enabled, students with approved payment get access immediately. If disabled, materials unlock on the seminar start date.",
    material_preview_public: "Visible before payment",
    material_preview_public_help: "Use this for open materials, such as the seminar curriculum.",
    material_preview_public_badge: "Preview",
    materials_link_unavailable: "This file will be enabled once your access is confirmed.",
    materials_empty_private: "The professor has not uploaded materials for this seminar yet.",
    materials_payment_required: "Your payment must be approved to access the materials.",
    materials_start_date_locked: "Materials will unlock on the seminar start date.",
    materials_enroll_and_pay_to_access: "Enroll and pay to access the materials.",
    materials_preview_note: "These materials are shared before payment. If the professor added other private materials, they unlock according to the seminar rules.",
    ...
    surplusExplanation: "If the total collected exceeds your target, {percent}% of the net surplus is yours as a bonus.",
    referralSuccess: "Share your link to reduce your price and earn bonuses!",
    economic_conditions_title: "Surplus and bonus conditions",
    economic_conditions_subtitle: "Clear summary of how Okalab settles surplus and when bonuses are released.",
    economic_conditions_professor_title: "For the professor",
    economic_conditions_professor_body: "If the seminar exceeds the target, you receive {percent}% of the net surplus as a bonus. Final economic settlement is confirmed when the payment window closes.",
    economic_conditions_referrals_title: "For referrals",
    economic_conditions_referrals_intro: "Share your invitation link. If your invitees pay and the seminar exceeds the target, you can earn bonuses. Conditions apply.",
    economic_conditions_referrals_rule_paid: "Only paid enrollments count when the payment window closes.",
    economic_conditions_referrals_rule_surplus: "Only students who actually ended up in the surplus and are attributable to your link generate bonuses.",
    economic_conditions_referrals_rule_release: "The bonus is released if you also paid your own enrollment within the window and the seminar finishes correctly.",
    economic_conditions_referrals_rule_fallback: "If those conditions are not met or there is no valid attributable referral, that value goes back to the professor and the platform.",
    economic_conditions_legal_note: "You can also review Support and Terms for the full detail of these rules.",
    economic_conditions_inline_cta: "Conditions apply.",
    economic_conditions_view: "View conditions",
    title: "Title",
  ...
  fr: {
    ...
    materials: "Matériaux",
    materials_immediate_access: "Matériaux disponibles après paiement",
    materials_immediate_access_help: "Si cette option est activée, les étudiants au paiement approuvé accèdent aux matériaux tout de suite. Sinon, ils seront ouverts à la date de début du séminaire.",
    material_preview_public: "Visible avant paiement",
    material_preview_public_help: "Utilisez ceci pour partager des matériaux ouverts, comme le programme du séminaire.",
    material_preview_public_badge: "Aperçu",
    materials_link_unavailable: "Ce fichier sera disponible lorsque votre accès sera confirmé.",
    materials_empty_private: "Le professeur n'a pas encore ajouté de matériaux pour ce séminaire.",
    materials_payment_required: "Votre paiement doit être approuvé pour accéder aux matériaux.",
    materials_start_date_locked: "Les matériaux seront disponibles à la date de début du séminaire.",
    materials_enroll_and_pay_to_access: "Inscrivez-vous et payez pour accéder aux matériaux.",
    materials_preview_note: "Ces matériaux sont partagés avant le paiement. Si le professeur a ajouté d'autres matériaux privés, ils se débloquent selon les règles du séminaire.",
    ...
    surplusExplanation: "Si le total collecte depasse votre objectif, {percent}% du surplus net vous revient comme bonus.",
    referralSuccess: "Partagez votre lien pour réduire votre prix et gagner des bonus!",
    economic_conditions_title: "Conditions du surplus et des bonus",
    economic_conditions_subtitle: "Resume clair de la facon dont Okalab liquide le surplus et libere les bonus.",
    economic_conditions_professor_title: "Pour le professeur",
    economic_conditions_professor_body: "Si le seminaire depasse l'objectif, vous recevez {percent}% du surplus net comme bonus. La liquidation economique finale est confirmee a la fermeture de la fenetre de paiement.",
    economic_conditions_referrals_title: "Pour les parrainages",
    economic_conditions_referrals_intro: "Partagez votre lien d'invitation. Si vos invites paient et que le seminaire depasse l'objectif, vous pouvez recevoir des bonus. Conditions applicables.",
    economic_conditions_referrals_rule_paid: "Seules les inscriptions payees comptent a la fermeture de la fenetre de paiement.",
    economic_conditions_referrals_rule_surplus: "Seuls les etudiants reellement en surplus et attribuables a votre lien generent un bonus.",
    economic_conditions_referrals_rule_release: "Le bonus est libere si vous avez aussi paye votre propre inscription dans la fenetre et si le seminaire se termine correctement.",
    economic_conditions_referrals_rule_fallback: "Si ces conditions ne sont pas remplies ou s'il n'y a pas de parrainage valable attribuable, cette valeur retourne au professeur et a la plateforme.",
    economic_conditions_legal_note: "Vous pouvez aussi consulter le Support et les Conditions pour le detail complet de ces regles.",
    economic_conditions_inline_cta: "Conditions applicables.",
    economic_conditions_view: "Voir les conditions",
    title: "Titre",
    description: "Description",
    category: "Catégorie",
    modality: "Modalité",
  ...
  ht: {
    ...
    download: "Telechaje",
    materials: "Materyèl",
    materials_immediate_access: "Materyèl disponib apre peman",
    materials_immediate_access_help: "Si opsyon sa a aktive, etidyan ki gen peman apwouve jwenn aksè touswit. Sinon, materyèl yo louvri nan dat kòmansman seminè a.",
    material_preview_public: "Vizib anvan peman",
    material_preview_public_help: "Sèvi ak sa pou pataje materyèl ouvè, tankou kourikoulòm seminè a.",
    material_preview_public_badge: "Apèsi",
    materials_link_unavailable: "Dosye sa a ap disponib lè aksè ou fin konfime.",
    materials_empty_private: "Pwofesè a poko telechaje materyèl pou seminè sa a.",
    materials_payment_required: "Peman ou dwe apwouve pou jwenn aksè ak materyèl yo.",
    materials_start_date_locked: "Materyèl yo ap louvri nan dat kòmansman seminè a.",
    materials_enroll_and_pay_to_access: "Enskri epi peye pou jwenn aksè ak materyèl yo.",
    materials_preview_note: "Materyèl sa yo pataje anvan peman. Si pwofesè a ajoute lòt materyèl prive, yo ap louvri selon règ seminè a.",
    ...
    surplusExplanation: "Si total la depase objektif ou, {percent}% nan siplis nèt la se bonus pa ou.",
    referralSuccess: "Pataje lyen ou pou redui pri ou epi jwenn bonifikasyon!",
    economic_conditions_title: "Kondisyon sou siplis ak bonus",
    economic_conditions_subtitle: "Rezime klè sou kijan Okalab fikse siplis la ak kilè bonus yo lage.",
    economic_conditions_professor_title: "Pou pwofesè a",
    economic_conditions_professor_body: "Si seminè a depase objektif la, ou resevwa {percent}% nan siplis nèt la kòm bonus. Likidasyon ekonomik final la konfime lè fenèt peman an fèmen.",
    economic_conditions_referrals_title: "Pou referans yo",
    economic_conditions_referrals_intro: "Pataje lyen envitasyon ou. Si moun ou envite yo peye epi seminè a depase objektif la, ou ka jwenn bonus. Kondisyon aplike.",
    economic_conditions_referrals_rule_paid: "Se sèlman enskripsyon ki peye yo ki konte lè fenèt peman an fèmen.",
    economic_conditions_referrals_rule_surplus: "Se sèlman etidyan ki rete vrèman nan siplis epi ki soti nan lyen ou ki bay bonus.",
    economic_conditions_referrals_rule_release: "Bonus la lage si ou menm tou ou te peye pwòp enskripsyon ou nan delè a epi seminè a fini kòrèkteman.",
    economic_conditions_referrals_rule_fallback: "Si kondisyon sa yo pa respekte oswa pa gen referans valab ki soti nan lyen ou, valè sa a retounen bay pwofesè a ak platfòm nan.",
    economic_conditions_legal_note: "Ou ka gade Sipò ak Tèm yo tou pou tout detay sou règ sa yo.",
    economic_conditions_inline_cta: "Kondisyon aplike.",
    economic_conditions_view: "Gade kondisyon yo",
    title: "Tit",
